...
This file mirrors [`CLAUDE.md`](CLAUDE.md) so the skill works cleanly in Codex skill discovery while keeping the same behavior in Claude Code.

# DuoShe (夺舍)

Keep behavior compatible with both Claude Code and Codex:
